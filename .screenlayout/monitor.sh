...
xrandr \
  ...
  xrandr \
    --output eDP-1 --mode 1920x1200 --rate 60 --pos 1595x1480 --rotate normal --scale 0.80x0.80 \
    --output DP-1-2 --primary --mode 2560x1440 --rate 120 --pos 1080x40 --rotate normal \
    --output DP-1-1 --rate 120 --mode 1920x1080 --pos 0x0 --rotate left \
    --output DP-1-3 --rate 75 --mode 1920x1080 --pos 3640x0 --rotate right
# xrandr --output eDP-1 --mode 1920x1200 --pos 456x1440 --rotate normal \
#   --output HDMI-1 --primary --mode 2560x1440 --pos 0x0 --rotate normal --output DP-1 --off --output DP-2 --off --output DP-3 --off --output DP-4 --off
