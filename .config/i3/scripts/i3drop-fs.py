...
# DROPDOWN_IDENTIFIER = "main_wezterm_layout"
DROPDOWN_IDENTIFIER = "main_alacritty_layout"
# DROPDOWN_CHILD_IDENTIFIER = "main_wezterm"
DROPDOWN_CHILD_IDENTIFIER = "main_alacritty"
INITIAL_TERMINAL_QUANTITY = 1
# TERMINAL_COMMAND          = f"wezterm start --class {DROPDOWN_CHILD_IDENTIFIER} -- /usr/bin/fish -c 'tmux attach-session -t main || tmux new -s main'"
TERMINAL_COMMAND = f"alacritty --class {DROPDOWN_CHILD_IDENTIFIER} -e /usr/bin/fish -c 'tmux attach-session -t main || tmux new -s main'"
