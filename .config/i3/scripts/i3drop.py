...
# TERMINAL_COMMAND          = f"wezterm start --class {DROPDOWN_CHILD_IDENTIFIER} -e /usr/bin/fish -c '/home/berin/.config/i3/scripts/tmux-drop && tmux attach-session -t dropdown'"
